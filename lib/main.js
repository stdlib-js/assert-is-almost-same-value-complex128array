...
* // returns false
*/
function isAlmostSameValueComplex128Array( v1, v2, maxULP ) { // eslint-disable-line id-length
	return ( isComplex128Array( v1 ) && isComplex128Array( v2 ) && hasAlmostSameValues( v1, v2, maxULP ) ); // eslint-disable-line max-len
}


// EXPORTS //

module.exports = isAlmostSameValueComplex128Array;
